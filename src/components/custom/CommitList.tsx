...
const CommitsList = () => {
    ...
    useEffect(() => {
        async function fetchCommits() {
            try {
                const response = await invoke('get_latest_commits', { owner: 'Onivoid', repo: 'Multitool' });
                ...
                <DialogContent>
                    ...
                    <ul className='pl-3'>
                        <li>
                            ...
                            - Feat
                            </span> : Nouvelles fonctionnalité
                        </li>
                        <li>
                            <span className='text-primary'>
                            - Bugfix
                            </span> : Correction de bug
                        </li>
                        <li>
                            <span className='text-primary'>
                            - Refactoring
                            </span> : Modification de code
                        </li>
                        <li>
                            <span className='text-primary'>
                            - Release
                            </span> : Nouvelle version
                        </li>
                    </ul>
                </DialogContent>
            </Dialog>
